					...
					<ul class="navbar-nav justify-content-center">
						...
						<li class="nav-item dropdown active">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item active" href="photography.php">Photography</a>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row cource-list-agile pt-4">
				...
				<div class="buttons-w3ls">
					<a class="btn button-cour-w3ls text-white" href="course_details.php" role="button">Learn More</a>
					<a class="btn bg-dark text-white" href="form.php" role="button">Apply Now</a>
				</div>
			</div>
