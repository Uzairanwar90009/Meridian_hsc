...
<head>
	<title>Edulearn Education Category Bootstrap Responsive Website Template | Single Page :: W3layouts</title>
	<!-- Meta tag Keywords -->
...
<body>
	...
	<header>
		...
		<div class="middle-w3ls-nav py-2">
			<div class="container">
				<div class="row">
					<a class="logo font-italic font-weight-bold col-lg-4 text-lg-left text-center" href="index.php">Edulearn</a>
			...
			<div class="row inner_sec_info pt-md-4">
				...
				<div class="col-lg-8 single-left">
					<div class="single-left1">
						...
						<h5 class="card-title">
							<a href="single.php" class="text-dark">Sed ut perspiciatis unde omnis iste natus error sit facilisis erat posuere erat</a>
						</h5>
						...
						<div class="col-md-6 single-left2-left">
							<ul>
								<li class="mt-3">
									...
									<a href="single.php">At vero eos et accusamus iusto</a>
								</li>
								<li class="mt-3">
									<i class="fas fa-check mr-2"></i>
									<a href="single.php">Sed ut perspiciatis unde omnis</a>
								</li>
								<li class="mt-3">
									<i class="fas fa-check mr-2"></i>
									<a href="single.php">Accusantium doloremque lauda</a>
								</li>
								<li class="mt-3">
									<i class="fas fa-check mr-2"></i>
									<a href="single.php">Vel illum qui dolorem fugiat quo</a>
								</li>
								<li class="mt-3">
									<i class="fas fa-check mr-2"></i>
									<a href="single.php">Quis autem vel eum repreh</a>
								</li>
								<li class="mt-3">
									<i class="fas fa-check mr-2"></i>
									<a href="single.php">Neque porro quisquam est qui</a>
								</li>
							</ul>
						</div>
						<div class="col-md-6 single-left2-left">
				...
				<div class="col-lg-4 event-right mt-lg-0 mt-sm-5 mt-4">
					<div class="event-right1">
							...
							<div class="posts-grids">
								<div class="row posts-grid mt-4">
									...
									<div class="col-lg-8 col-md-7 col-8 posts-grid-right mt-lg-0 mt-md-5 mt-sm-4">
										<h4>
											<a href="single.php" class="text-dark">Sed ut perspiciatis unde omni</a>
										</h4>
										<ul class="wthree_blog_events_list mt-2">
											...
											<li>
												...
												<a href="single.php" class="text-dark ml-2">Admin</a>
											</li>
										</ul>
									</div>
								</div>
						...
						<div class="tags mt-4 p-4 border">
							...
							<ul class="mt-4">
								<li>
									<a href="course_details.php" class="text-dark border">Designs</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Growth</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Latest</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Price</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Tools</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Business</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Work Space</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">New Course</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Advantage</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Concepts</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Arts</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Photography</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Research</a>
								</li>
								<li>
									<a href="course_details.php" class="text-dark border">Software</a>
								</li>
							</ul>
						</div>
					</div>
