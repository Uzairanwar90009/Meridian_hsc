...
<body>
	...
	<div class="about py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Welcome to
				<span class="font-weight-bold">Meridian High School</span>
			</h3>
				...
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="language.php">
							...
							<div class="info">
								<h3 class="text-capitalize text-white">High School Campus</h3>
								<!-- <p>Description goes here</p> -->
							</div>
						</a>
					</div>
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="language.php" class="text-dark">High School Online Campus
				...
				<div class="col-lg-4 col-news-top text-center my-lg-0 my-sm-5 my-4">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="communication.php">
							...
							<div class="info">
								<h3 class="text-capitalize text-white">Home Based Online Learning</h3>
								<!-- <p>Description goes here</p> -->
							</div>
						</a>
					</div>
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="communication.php" class="text-dark">Online Learning
							<i class="fas fa-long-arrow-alt-right ml-1"></i>
						</a>
					</h6>
					<!-- end normal -->
				...
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="business.php">
							...
							<div class="info">
								<h3 class="text-capitalize text-white">High School Online Store</h3>
								<!-- <p>Description goes here</p> -->
							</div>
						</a>
					</div>
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="business.php" class="text-dark">Online Store
							<i class="fas fa-long-arrow-alt-right ml-1"></i>
						</a>
					</h6>
					<!-- end normal -->
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row">
				<div class="col-lg-7 video">
					...
					<iframe src="https://www.youtube.com/embed/7UydMbnekVA"></iframe>
				</div>
	...
	<!-- testimonials -->
	<div class="testimonials py-5" style="display: none;">
		<div class="container py-xl-5 py-lg-3">
